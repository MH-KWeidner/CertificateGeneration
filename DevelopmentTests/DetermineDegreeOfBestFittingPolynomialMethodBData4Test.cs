...
namespace DevelopmentTests
{
    ...
    public class DetermineDegreeOfBestFittingPolynomialMethodBData4Test
    {
        ...
        public void DetermineDegreeOfBestFittingPolynomial_ValidInput_ReturnsExpectedInterpolatedValues()
        {
            ...
            Series series1 = Series.CreateSeries(1, appliedForce, MethodBNistTestData4.GetRawDataSeries1());
            Series series2 = Series.CreateSeries(2, appliedForce, MethodBNistTestData4.GetRawDataSeries2());
            Series series3 = Series.CreateSeries(3, appliedForce, MethodBNistTestData4.GetRawDataSeries3());
