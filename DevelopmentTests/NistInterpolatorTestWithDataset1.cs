...
namespace DevelopmentTests
{
    ...
    public class NistInterpolatorTestWithDataset1
    {
        ...
        public void InterpolateSeries_ValidInput_ReturnsExpectedInterpolatedValues()
        {
            ...
            Assert.AreEqual(-2.04022, Math.Round(series1.GetValue(5), 5));
            Assert.AreEqual(-2.44847, Math.Round(series1.GetValue(6), 5));
            Assert.AreEqual(-2.85675, Math.Round(series1.GetValue(7), 5));
            Assert.AreEqual(-3.26505, Math.Round(series1.GetValue(8), 5));
            Assert.AreEqual(-3.67339, Math.Round(series1.GetValue(9), 5));
            Assert.AreEqual(-4.08166, Math.Round(series1.GetValue(10), 5));
            ...
            Assert.AreEqual(-2.04027, Math.Round(series2.GetValue(5), 5));
            Assert.AreEqual(-2.44851, Math.Round(series2.GetValue(6), 5));
            Assert.AreEqual(-2.85680, Math.Round(series2.GetValue(7), 5));
            Assert.AreEqual(-3.26511, Math.Round(series2.GetValue(8), 5));
            Assert.AreEqual(-3.67344, Math.Round(series2.GetValue(9), 5));
            Assert.AreEqual(-4.08172, Math.Round(series2.GetValue(10), 5));
            ...
            Assert.AreEqual(-2.04026, Math.Round(series3.GetValue(5), 5));
            Assert.AreEqual(-2.44851, Math.Round(series3.GetValue(6), 5));
            Assert.AreEqual(-2.85679, Math.Round(series3.GetValue(7), 5));
            Assert.AreEqual(-3.26511, Math.Round(series3.GetValue(8), 5));
            Assert.AreEqual(-3.67342, Math.Round(series3.GetValue(9), 5));
            Assert.AreEqual(-4.08168, Math.Round(series3.GetValue(10), 5));
        }
    }
}