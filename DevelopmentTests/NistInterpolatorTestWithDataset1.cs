...
namespace DevelopmentTests
{
    ...
    public class NistInterpolatorTestWithDataset1
    {
        ...
        public void InterpolateSeries_ValidInput_ReturnsExpectedInterpolatedValues()
        {
            ...
            // Act
            List<int> ExcludedAppliedForcesByIndex = [12];
            series1.RemoveValuesByIndex(ExcludedAppliedForcesByIndex);
            series2.RemoveValuesByIndex(ExcludedAppliedForcesByIndex);
            series3.RemoveValuesByIndex(ExcludedAppliedForcesByIndex);
            ...
            IList<SingleRunPoint> LabSchedulePoints = MethodBNISTTestData1LabScheduleResults.dataList;

            // Assert
            Assert.AreEqual(series1.CountValues(), LabSchedulePoints.Count);
