...
namespace DevelopmentTesting
{
    ...
    public class NistInterpolatorTestWithDataset1
    {
        ...
        public void InterpolateSeries_ValidInput_ReturnsExpectedInterpolatedValues()
        {
            ...
            Series series1 = Series.CreateSeries(1, appliedForce, TestData1.GetRawDataSeries1());
            Series series2 = Series.CreateSeries(2, appliedForce, TestData1.GetRawDataSeries2());
            Series series3 = Series.CreateSeries(3, appliedForce, TestData1.GetRawDataSeries3());
